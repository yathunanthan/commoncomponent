(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/common/http'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('parentpayment', ['exports', '@angular/core', '@angular/forms', '@angular/common/http', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.parentpayment = {}, global.ng.core, global.ng.forms, global.ng.common.http, global.ng.common));
})(this, (function (exports, i0, i1$1, i1, i3) { 'use strict';
        ...
        PaymentBankDetailsComponent.prototype.buildPaymetForm = function () {
            if (this.paymentType == 1) {
                ...
                this.paymentForm = this.fb.group({
                    ...
                    accountNo: ['', [i1$1.Validators.required,]],
                    routingNo: ['', [i1$1.Validators.required]],
                    accountType: ['', [i1$1.Validators.required]],
    ...
    var PaymentCardDetailsComponent = /** @class */ (function () {
        ...
        PaymentCardDetailsComponent.prototype.buildCreditForms = function () {
            ...
            this.creditForm = this.fb.group({
                payment: this.fb.group({
                    ...
                    'cardNumber': ['', [i1$1.Validators.required, 'c']],
                    'cardCvc': ['', [i1$1.Validators.required, i1$1.Validators.maxLength(3), i1$1.Validators.maxLength(4)]],
                    'paymentDate': [date,],
                    ...
                    'expiry': ['', [i1$1.Validators.required, '']],
        ...
        PaymentCardDetailsComponent.prototype.cardSelected = function (val, from) {
            ...
            this.creditForm = this.fb.group({
                ...
                'description': ["Invoice no : #" + this.userData.invoiceDetails.invoiceNumber],
                'reference': ['Invoice no : #' + this.userData.invoiceDetails.invoiceNumber,],
                'paymentMethod': [this.userData.cardCharges[this.userData.cardCharges.length - 1].paymentMethodId, [i1$1.Validators.required]],
    ...
    ParentpaymentModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ParentpaymentModule, declarations: [ParentpaymentComponent,
            ...
            i1$1.FormsModule], exports: [ParentpaymentComponent] });

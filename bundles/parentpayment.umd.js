    ...
    var PaymentCardDetailsComponent = /** @class */ (function () {
        ...
        PaymentCardDetailsComponent.prototype.buildCreditFormS = function () {
            ...
            if (((_f = (_e = this.cardPaymentData) === null || _e === void 0 ? void 0 : _e.cardCharges) === null || _f === void 0 ? void 0 : _f.length) != 0) {
                paymentId = (_j = (_g = this.cardPaymentData) === null || _g === void 0 ? void 0 : _g.cardCharges[(_h = this.commomPaymentService) === null || _h === void 0 ? void 0 : _h.cardCharges]) === null || _j === void 0 ? void 0 : _j.paymentMethodId;
            }
            this.creditForm = this.fb.group({
                'amount': [((_k = this.cardPaymentData) === null || _k === void 0 ? void 0 : _k.showDeposit) ? (_l = this.cardPaymentData) === null || _l === void 0 ? void 0 : _l.showDeposit : ''],
                'cardCharge': [((_m = this.cardPaymentData) === null || _m === void 0 ? void 0 : _m.cardCharges[0].charge) ? this.cardPaymentData.cardCharges[0].charge : (_p = (_o = this.cardPaymentData) === null || _o === void 0 ? void 0 : _o.paymentCharge[0]) === null || _p === void 0 ? void 0 : _p.charge],
                'cardName': [((_r = (_q = this.cardPaymentData) === null || _q === void 0 ? void 0 : _q.customerDetails) === null || _r === void 0 ? void 0 : _r.customerName) ? this.cardPaymentData.customerDetails.customerName : (_s = this.cardPaymentData) === null || _s === void 0 ? void 0 : _s.customerName, [i1$1.Validators.required]],
                'cardNumber': ['', [i1$1.Validators.required, angularCcLibrary.CreditCardValidators.validateCCNumber]],
                'cardCvc': ['', [i1$1.Validators.required, i1$1.Validators.minLength(3), i1$1.Validators.maxLength(4)]],
                'paymentDate': [date],
                'description': [invoiceNo],
                'isportal': [true],
                'reference': [invoiceNo],
                'email': [((_u = (_t = this.cardPaymentData) === null || _t === void 0 ? void 0 : _t.customerDetails) === null || _u === void 0 ? void 0 : _u.emailId) ? this.cardPaymentData.customerDetails.emailId : '', [i1$1.Validators.required, i1$1.Validators.email]],
                'expiry': ['', [i1$1.Validators.required, angularCcLibrary.CreditCardValidators.validateExpDate]],
                "paymentMethod": [paymentId ? paymentId : ''],
                "dontSendToAccounts": [''],
            });
            this.placeholders = { name: ((_w = (_v = this.cardPaymentData) === null || _v === void 0 ? void 0 : _v.customerDetails) === null || _w === void 0 ? void 0 : _w.customerName) ? this.cardPaymentData.customerDetails.customerName : 'Full Name' };
        };

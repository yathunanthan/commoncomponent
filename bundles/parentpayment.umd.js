    ...
    var PaymentCardDetailsComponent = /** @class */ (function () {
        ...
        PaymentCardDetailsComponent.prototype.buildCreditFormS = function () {
            ...
            this.creditForm = this.fb.group({
                ...
                'cardCharge': [((_g = this.cardPaymentData) === null || _g === void 0 ? void 0 : _g.cardCharges[0].charge) ? this.cardPaymentData.cardCharges[0].charge : (_j = (_h = this.cardPaymentData) === null || _h === void 0 ? void 0 : _h.paymentCharge[0]) === null || _j === void 0 ? void 0 : _j.charge],
                'cardName': [((_l = (_k = this.cardPaymentData) === null || _k === void 0 ? void 0 : _k.customerDetails) === null || _l === void 0 ? void 0 : _l.customerName) ? this.cardPaymentData.customerDetails.customerName : (_m = this.cardPaymentData) === null || _m === void 0 ? void 0 : _m.customerName, [i1$1.Validators.required]],
                'cardNumber': ['', [i1$1.Validators.required, angularCcLibrary.CreditCardValidators.validateCCNumber]],
                'cardCvc': ['', [i1$1.Validators.required, i1$1.Validators.minLength(3), i1$1.Validators.maxLength(4)]],
                'paymentDate': [date],
                'description': [invoiceNo],
                'isportal': [true],
                'reference': [invoiceNo],
                'email': [((_p = (_o = this.cardPaymentData) === null || _o === void 0 ? void 0 : _o.customerDetails) === null || _p === void 0 ? void 0 : _p.emailId) ? this.cardPaymentData.customerDetails.emailId : '', [i1$1.Validators.required, i1$1.Validators.email]],
                'expiry': ['', [i1$1.Validators.required, angularCcLibrary.CreditCardValidators.validateExpDate]],
                "paymentMethod": [''],
                "dontSendToAccounts": [''],
            });
            this.placeholders = { name: ((_r = (_q = this.cardPaymentData) === null || _q === void 0 ? void 0 : _q.customerDetails) === null || _r === void 0 ? void 0 : _r.customerName) ? this.cardPaymentData.customerDetails.customerName : 'Full Name' };
        };

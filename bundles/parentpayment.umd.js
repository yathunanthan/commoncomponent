(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@angular/forms'), require('@angular/common'), require('angular-cc-library'), require('ngx-card')) :
    typeof define === 'function' && define.amd ? define('parentpayment', ['exports', '@angular/core', '@angular/common/http', '@angular/forms', '@angular/common', 'angular-cc-library', 'ngx-card'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.parentpayment = {}, global.ng.core, global.ng.common.http, global.ng.forms, global.ng.common, global.angularCcLibrary, global.i4));
})(this, (function (exports, i0, i1, i1$1, i3, angularCcLibrary, i4) { 'use strict';
    ...
    var PaymentCardDetailsComponent = /** @class */ (function () {
        ...
        PaymentCardDetailsComponent.prototype.cardSelected = function (val, from) {
            ...
            intArr.forEach(function (element) {
                var tagsData = _this.storedCards.find(function (x) { return x['id'] == element; });
    ...
    var PaymentDetailsComponent = /** @class */ (function () {
        ...
        PaymentDetailsComponent.prototype.ngOnInit = function () {
            ...
            this.settings = this.genericPaymentDetails.settings.reduce(function (obj, item) {
                var _a;
                return Object.assign(obj, (_a = {}, _a[item.key] = item.value, _a));
            }, {});
    ...
    var ParentpaymentComponent = /** @class */ (function () {
        ...
        ParentpaymentComponent.prototype.ngOnInit = function () {
            ...
            this.commonService.getStorecard(this.paymentDetails.invoiceDetails.invoiceAddressId).subscribe(function (res) {
                _this.storedCardData = res.records;
            });
        };

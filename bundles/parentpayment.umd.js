(function (global, factory) {
    ...
    var PaymentCompleteComponent = /** @class */ (function () {
        function PaymentCompleteComponent(commonPaymentService) {
        ...
        PaymentCompleteComponent.prototype.ngOnInit = function () {
            var _a;
            this.completePaymentData = this.commonPaymentService.completePageData;
            this.cardCharges = this.completePaymentData.cardCharges[this.commonPaymentService.cardCharges].charge;
            console.log('completePaymentData', this.completePaymentData);
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PaymentCompleteComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: CommonPaymentService }]; }, propDecorators: { paymentId: [{
                    type: i0.Input
                }], valid: [{
                    type: i0.Input
                }], paymentType: [{

(function (global, factory) {
    ...
    var PaymentCardDetailsComponent = /** @class */ (function () {
        ...
        PaymentCardDetailsComponent.prototype.buildCreditFormS = function () {
            ...
            var invoiceNo;
            if ((_a = this.cardPaymentData.invoiceDetails) === null || _a === void 0 ? void 0 : _a.invoiceNumber) {
                invoiceNo = ((_c = (_b = this.cardPaymentData) === null || _b === void 0 ? void 0 : _b.invoiceDetails) === null || _c === void 0 ? void 0 : _c.invoiceNumber) ? "Invoice no : " + this.cardPaymentData.invoiceDetails.invoiceNumber : '';
            }
            else {
                invoiceNo = 'Opportunity no: ' + this.cardPaymentData.opportunityId;
            }
            ...
            this.creditForm = this.fb.group({
                ...
                'cardCharge': [((_g = this.cardPaymentData) === null || _g === void 0 ? void 0 : _g.cardCharges[0].charge) ? this.cardPaymentData.cardCharges[0].charge : this.cardPaymentData.paymentCharge[0].charge],
                'cardName': [((_j = (_h = this.cardPaymentData) === null || _h === void 0 ? void 0 : _h.customerDetails) === null || _j === void 0 ? void 0 : _j.customerName) ? this.cardPaymentData.customerDetails.customerName : this.cardPaymentData.customerName, [i1$1.Validators.required]],
                'cardNumber': ['', [i1$1.Validators.required, angularCcLibrary.CreditCardValidators.validateCCNumber]],
                'cardCvc': ['', [i1$1.Validators.required, i1$1.Validators.minLength(3), i1$1.Validators.maxLength(4)]],
                'paymentDate': [date],
                'description': [invoiceNo],

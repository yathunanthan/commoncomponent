...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: PaymentBankDetailsComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1.FormBuilder }]; }, propDecorators: { paymentData: [{
                type: Input
            }], paymentTypeS: [{
                type: Input
            }], payEmitter: [{
...
export { ParentpaymentComponent, ParentpaymentModule, ParentpaymentService, PaymentBankDetailsComponent, PaymentCardDetailsComponent, PaymentDetailsComponent };

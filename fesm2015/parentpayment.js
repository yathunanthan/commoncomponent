...
class PaymentCardDetailsComponent {
    constructor(fb, commomPaymentService) {
        ...
        console.log('portal', this.portalName);
    ...
    buildCreditForms() {
        ...
        else if ((_c = this.cardPaymentData) === null || _c === void 0 ? void 0 : _c.reminderId) {
            invoiceNo = "Service reminder instance : #" + this.cardPaymentData.reminderId;
        }
        else {
            invoiceNo = 'Opportunity no: ' + this.cardPaymentData.opportunityId;
        }
        let paymentId;
        if (((_d = this.cardPaymentData) === null || _d === void 0 ? void 0 : _d.cardCharges.length) != 0) {
            paymentId = this.cardPaymentData.cardCharges[this.commomPaymentService.cardCharges].paymentMethodId;
        }
        this.creditForm = this.fb.group({
            payment: this.fb.group({
                'amount': [this.cardPaymentData.amount ? this.cardPaymentData.amount : ''],
                ...
                'cardName': [((_g = (_f = this.cardPaymentData) === null || _f === void 0 ? void 0 : _f.customerDetails) === null || _g === void 0 ? void 0 : _g.customerName) ? this.cardPaymentData.customerDetails.customerName : this.cardPaymentData.customerName, [Validators.required]],
                ...
                'isportal': [true],
                'reference': [invoiceNo],
                'email': [((_j = (_h = this.cardPaymentData) === null || _h === void 0 ? void 0 : _h.customerDetails) === null || _j === void 0 ? void 0 : _j.emailId) ? this.cardPaymentData.customerDetails.emailId : '', [Validators.required, Validators.email]],

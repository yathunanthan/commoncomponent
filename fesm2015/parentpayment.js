...
class PaymentCardDetailsComponent {
    ...
    cardSelected(val, from) {
        ...
        intArr.forEach((element) => {
            const tagsData = this.storedCards.find((x) => x['id'] == element);
